          ...
          <div className="lg:col-span-2">
            ...
            <div>
              ...
              <div className="flex space-x-2">
                <a href="https://line.me/R/ti/p/@sphardware9" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-green-500 hover:bg-green-600 text-white rounded-full flex items-center justify-center transition-colors">
